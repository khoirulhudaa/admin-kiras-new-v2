...
//         schoolId: schoolId.toString(),
//         year: filters.year,
//         role: filters.role, // Tambahkan role (student/teacher)
//         ...(type === 'monthly' && { month: filters.month }),
//         // Hanya kirim className jika role-nya adalah student
...
//       // Penamaan file yang lebih informatif
...
//                   role: r, 
//                   page: 1, 
//                   class: "" // Reset filter kelas setiap ganti role
//                 })}
...
//       {/* Filter Bar */}
//       <div className={`grid grid-cols-1 md:grid-cols-2 ${filters.role === 'student' ? 'lg:grid-cols-4' : 'lg:grid-cols-3'} gap-4 mb-6`}>
//         {
...
//         <div className="flex w-full gap-4 lg:col-span-2">
//            <select 
//             className="flex-1 w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-4 text-sm outline-none focus:border-blue-500 transition-all appearance-none cursor-pointer font-bold"
//             value={filters.month}
    ...
    <div className="min-h-screen" style={{ color: "#f8fafc" }}>
      ...
      <AnimatePresence mode="wait">
        {activeTab === 'log' ? (
          ...
          >
            {/* Filter Bar */}
            <div className={`grid grid-cols-1 md:grid-cols-2 ${filters.role === 'student' ? 'lg:grid-cols-2' : 'lg:grid-cols-1'} gap-4 mb-6`}>
              {filters.role === 'student' && (
                <div className="relative group lg:col-span-1">
                  <BookOpen className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-500 group-focus-within:text-blue-500 transition-colors z-10" size={16} />
                  <select 
              ...
              <div className="w-full gap-4 grid grid-cols-2">
                ...
                <div className="relative group">
                  ...
                  <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-500 pointer-events-none group-focus-within:text-blue-500 transition-colors z-20" size={16} />
                </div>
