...
const API_BASE = "http://localhost:5005/berita"; // sesuaikan jika route berbeda
// const API_BASE = "https://be-school.kiraproject.id/berita"; // sesuaikan jika route berbeda
...
const useAlert = () => {
  const [alert, setAlert] = useState<any>({ message: "", isVisible: false });
...
export default function BeritaPage() {
  ...
  // JSX sama persis seperti PengumumanPage, hanya ganti teks
  return (
          ...
          <div className="fixed top-0 right-0 inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              <Transition.Child as={Fragment} enter="ease-out duration-300" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="ease-in duration-200" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
                <Dialog.Panel className="absolute top-0 right-0 w-full max-w-md h-screen overflow-auto transform border border-white/10 bg-black/60 p-6 text-left align-middle shadow-2xl">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="w-full grid grid-cols-2 justify-end gap-4 pt-6 border-t borde-white/10">
                      ...
                      <button type="submit" disabled={loading} className="inline-flex justify-center items-center gap-2 rounded-xl bg-blue-500 px-6 py-2.5 text-sm font-medium text-white hover:bg-blue-600 disabled:opacity-60 transition">
